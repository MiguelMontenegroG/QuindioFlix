...
export const mockEmpleados: Empleado[] = [
  { id: 1, nombre: 'Ana García', email: 'ana.garcia@quindioflix.com', departamento: 'Moderación', rol_oracle: 'ROL_SOPORTE', es_jefe_departamento: true, fecha_ingreso: '2023-01-15' },
  { id: 2, nombre: 'Carlos López', email: 'carlos.lopez@quindioflix.com', departamento: 'Contenido', rol_oracle: 'ROL_CONTENIDO', es_jefe_departamento: false, fecha_ingreso: '2023-03-20' },
  { id: 3, nombre: 'María Rodríguez', email: 'maria.rodriguez@quindioflix.com', departamento: 'Soporte', rol_oracle: 'ROL_SOPORTE', es_jefe_departamento: false, fecha_ingreso: '2023-06-10' },
  { id: 4, nombre: 'Pedro Martínez', email: 'pedro.martinez@quindioflix.com', departamento: 'Administración', rol_oracle: 'ROL_ADMIN', es_jefe_departamento: true, fecha_ingreso: '2022-08-01' },
]
