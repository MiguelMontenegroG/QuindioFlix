  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-12 px-4 md:px-12">
        <h1 className="text-4xl font-bold text-foreground mb-8">Series</h1>
        {filtrado.length > 0 ? (
          <ContentCarousel title="Series" contenido={filtrado} favoritos={favoritos} onFavoriteToggle={handleFavoriteToggle} />
        ) : (
